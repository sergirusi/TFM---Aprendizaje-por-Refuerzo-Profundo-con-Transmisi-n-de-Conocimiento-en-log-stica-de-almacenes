...
public class DRLInferenceAgent : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        currentDropZone = dropZones.transform.GetChild(UnityEngine.Random.Range(0, 10)).gameObject;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (!agentPackage.activeSelf && other.gameObject.tag == "Goal")
        {
            AddReward(0.5f);
            agentPackage.SetActive(true);
            trolley.SetActive(false);
        ...
        else if (agentPackage.activeSelf && other.gameObject.tag == "Goal" && other.gameObject.name != "Trolley")
        {
            AddReward(0.5f);
            UpdateTrainingStatus();
            EndEpisode();
        }
        else if (other.gameObject.tag == "Wall" || other.gameObject.tag == "Pillar" || other.gameObject.tag == "Pedestal" || other.gameObject.tag == "Shelf" || other.gameObject.tag == "Worker" || other.gameObject.tag == "Shelf")
        {
            AddReward(-1f);
            UpdateTrainingStatus();
            EndEpisode();
